...
#define setfileno(request, paths) 0
	...
	char **envp;
{
	...
	typeset(tsh_version, 0, 0); /* RDONLY */
	...
	for (i = 0; tshbuiltins[i].name != NULL; i++)
		builtin(tshbuiltins[i].name, tshbuiltins[i].func);
