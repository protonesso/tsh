 ...
 *		that more closely follows the real tsh way of doing
 ...
 *	All copies of tsh looking at the file will maintain the
 *	same history. This is tsh behaviour.
 *
